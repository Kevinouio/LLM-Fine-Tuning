...
## Goal
Turn research paper text into a structured JSON digest and a short, simple explanation.
...
## Outputs
- output_json that validates against schemas/paper_digest.schema.json.
